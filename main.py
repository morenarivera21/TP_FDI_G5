...
# Rutas de consultas a la API de terceros

apiKey = "ded5dd939a5b7c02796ffd9554c45ce4"
...
def createUser():
    return jsonify(mydb.create_user(request.json['nombre_de_usuario'], request.json['email'], request.json['nombre'],
